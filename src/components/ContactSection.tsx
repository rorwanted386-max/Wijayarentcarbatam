      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            ...
            {/* WhatsApp CTA */}
            <a 
              href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20booking%20mobil" 
              target="_blank" 
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+6281234567890" className="text-foreground font-medium hover:text-accent transition-colors">
                    +62 812-3456-7890
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@wijayarentcar.com" className="text-foreground font-medium hover:text-accent transition-colors">
          ...
          <div 
            className="bg-card rounded-3xl p-8 shadow-soft opacity-0 animate-slide-in-right"
          ...
          >
            ...
            <div className="aspect-video rounded-2xl overflow-hidden bg-muted relative">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126915.49456488872!2d106.68943194023437!3d-6.229386900000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta%2C%20Indonesia!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
