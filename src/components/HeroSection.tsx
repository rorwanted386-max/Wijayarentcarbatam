  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={heroBg} 
          alt="Perjalanan wisata dengan mobil rental" 
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main heading */}
          <h1 
            className="font-display text-4xl md:text-5xl lg:text-6xl text-primary-foreground mb-6 leading-tight opacity-0 animate-fade-in-up"
          ...
          {/* Subheading */}
          <p 
            className="text-lg md:text-xl text-primary-foreground/90 mb-10 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
          ...
          {/* Quick Info */}
          <div 
            className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto opacity-0 animate-fade-in-up"
          ...
          >
            <div className="flex items-center justify-center gap-3 text-primary-foreground/90">
              ...
              <span className="font-medium">Melayani Seluruh Indonesia</span>
            </div>
            <div className="flex items-center justify-center gap-3 text-primary-foreground/90">
              <div className="p-3 bg-accent/20 rounded-full">
